...
import com.LnPay.driver.Ratings;
...
import com.LnPay.driver.fastClass.UpdatedDriverLocationWorker;
...
import static com.LnPay.driver.fastClass.DistanceCalc.distanceBtnCoordinates;
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            db.collection("Rides").document(rideId).update("driversStatus", "Completed").addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    ...
                                    startActivity(new Intent(UploadedRideMap.this, AccountActivity.class));
